...
-- 2. Secure Employee Data (user_profiles table)
...
-- 7. Secure Financial Products
DROP POLICY IF EXISTS "Allow all operations" ON public.financial_products;

CREATE POLICY "Authenticated users can view financial products" 
ON public.financial_products 
FOR SELECT 
USING (auth.role() = 'authenticated');

CREATE POLICY "FS_OPS can modify financial products" 
ON public.financial_products 
FOR ALL 
USING (
  EXISTS (
...
-- 8. Secure Financial Program Configs
DROP POLICY IF EXISTS "Allow all operations" ON public.financial_program_configs;

CREATE POLICY "Authenticated users can view financial program configs" 
ON public.financial_program_configs 
FOR SELECT 
USING (auth.role() = 'authenticated');

CREATE POLICY "FS_OPS can modify financial program configs" 
ON public.financial_program_configs 
FOR ALL 
USING (
  EXISTS (
